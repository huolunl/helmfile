...
func execFaster(extra []string, description string, args ...string) ([]byte, error) {
	os.Args = args
	writer := &bytes.Buffer{}
	cliApp := cli.NewApp()
...
func ExecFaster(meta []string, Description string, args ...string) ([]byte, error) {
	return execFaster(meta, Description, args...)
}
